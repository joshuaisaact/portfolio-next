...
export const metadata = {
  ...
  date: "2024-08-24",
  featured_image: "media/skills/hugo.svg",
  excerpt:
...
<Figure
  src="/images/blog/hugo/json template.png"
  alt="JSON file template"
  title="Not that I'm an expert, I'm sure you can make a more useful one, but this worked for me"
/>

...
I'm continuing to improve my Go knowledge, ahead of further refining this MVP. It needs a proper frontend, and also I need to improve the train position interpolation, ahead of implementing multiple other lines.

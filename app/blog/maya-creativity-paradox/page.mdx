...
import YogaDataStructure from "@/app/components/mdx/YogaDataStructure";


export const postMetadata = {
  title: "The AI Creativity Paradox: Why Smarter Isn't Always More Creative",
  date: "2025-07-30", // or whenever you publish
...
export const metadata = generateMetadataFromPost(postMetadata, "maya-creativity-paradox");

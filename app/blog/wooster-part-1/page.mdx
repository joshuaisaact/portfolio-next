...
2. **Frontend**: Considered Next.js, but learning a new framework in a week? That's a bit like trying to learn Japanese the night before a holiday to Tokyo
...
<Figure
  ...
  title="He can even help you with tech stacks too!"
/>

## The Features (Or: A List of Things I'll Probably Regret Promising)

I fired up Excalidraw (other drawing tools are available, but are they this adorably basic?) and mapped out two lists:
...
<Figure
  src="/images/blog/ai-trip/excalidraw-mess.png"
  alt="My Excalidraw wireframes"
  title="My wireframes. Leonardo da Vinci can rest easy."
/>

## What Could Possibly Go Wrong?

With planning done and optimism still inexplicably high, it was time to start building. Join me in part 2 where I discover exactly how many cups of coffee it takes to build an AI travel planner, and whether Wooster's digital reincarnation is more "helpful assistant" or "chaotic good".

      ...
      foundSequences: [
        {
          ...
          description: "Calming sequence to release tension",
          difficulty: "beginner",
        ...
        },
        {
          ...
          description: "Soothing poses for winding down",
          difficulty: "beginner",
          targetDurationMinutes: 12,
          intensity: "gentle",
        }
      ],
      suggestions: ["Start Evening Wind-Down Flow", "I want something different", "Create something custom"],
      delay: 2500,
    },
    {
      id: "4",
      type: "user" as const,
      content: "I want something different",
      timestamp: new Date(),
      delay: 4000,
    },
    {
      id: "5",
      type: "maya" as const,
      content: "Let me look for more options... I found these additional bedtime sequences:",
      timestamp: new Date(),
      foundSequences: [
        {
          id: "4",
          name: "Sleepy Time Stretch",
          description: "Gentle stretches for bedtime",
          difficulty: "beginner",
        ...
        },
        {
          id: "5",
          name: "Moonlight Flow",
          description: "Calming lunar-inspired sequence",
          difficulty: "beginner",
          targetDurationMinutes: 16,
          intensity: "gentle",
        }
      ],
      suggestions: ["These all look the same...", "Can you create something new?", "Start Moonlight Flow"],
      delay: 5500,
    },
  ],
};
